...
function MapLoader(file) {
  ...
  aqsc.then(function () {
    if (lodashEs.isArray(file) && file.length > 0) {
  ...
  _createClass(MapDraw, [{
    ...
    value: function () {
      var _createWFSLayer = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(options) {
        var params, url, u, data, wfsLayer;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                wmsLayer = window.L.tileLayer.wms(options.url, config);
...
var getLocation = function getLocation(obj) {
...
var Utils = _objectSpread2({}, location);
